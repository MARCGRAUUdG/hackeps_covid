...
class AdminRole extends ActionFilter
{
    /**
    ...
    public function beforeAction($action)
    {
        ...
        if (!$user->isGuest && $user->identity->role == \common\models\User::ROLE_ADMIN) {
            return true;
        }
    ...
    protected function denyAccess($user)
    {
        if ($user !== false && $user->getIsGuest()) {
            ...
            throw new ForbiddenHttpException(Yii::t('yii', 'No tienes permiso para ver ésta página.'));
        }
    }
}
